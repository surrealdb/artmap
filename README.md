...
| Data Structure | Point&nbsp;Read (Random&nbsp;Hit) | Sequential&nbsp;Insert | Random&nbsp;Insert | Range&nbsp;Scan (100&nbsp;items) | Allocations /&nbsp;Insert | Drop /&nbsp;Reset |
| :--- | ---: | ---: | ---: | ---: | ---: | ---: |
| **`artmap::ArenaArtMap`**<br><sup>&nbsp;(with Inserter)</sup> | — | <img width="16" align="absmiddle" src="/img/rocket.png" alt="🚀">&nbsp;**25.3&nbsp;ns**<br><sup>(39.5M/s)</sup> | — | — | **0&nbsp;allocs** | **$O(1)$** |
| **`artmap::ArenaArtMap`**<br><sup>&nbsp;(Standard Key)</sup> | <img width="16" align="absmiddle" src="/img/rocket.png" alt="🚀">&nbsp;**14.5&nbsp;ns**<br><sup>(69.0M/s)</sup> | **27.2&nbsp;ns**<br><sup>(36.8M/s)</sup> | <img width="16" align="absmiddle" src="/img/rocket.png" alt="🚀">&nbsp;**33.9&nbsp;ns**<br><sup>(29.5M/s)</sup> | <img width="16" align="absmiddle" src="/img/rocket.png" alt="🚀">&nbsp;**570&nbsp;ns**<br><sup>(175.5M/s)</sup> | **0&nbsp;allocs** | **$O(1)$** |
| **`artmap::ArenaArtMap`**<br><sup>&nbsp;(Slice Lookup)</sup> | **14.8&nbsp;ns**<br><sup>(67.7M/s)</sup> | — | — | — | **0&nbsp;allocs** | **$O(1)$** |
| **`artmap::ArtMap`**<br><sup>&nbsp;(with Inserter)</sup> | — | **34.3&nbsp;ns**<br><sup>(29.2M/s)</sup> | — | — | **1.0&nbsp;allocs** | $O(N)$ epoch |
| **`artmap::ArtMap`**<br><sup>&nbsp;(Standard Key)</sup> | **15.0&nbsp;ns**<br><sup>(66.6M/s)</sup> | **26.1&nbsp;ns**<br><sup>(38.2M/s)</sup> | **52.5&nbsp;ns**<br><sup>(19.0M/s)</sup> | **657&nbsp;ns**<br><sup>(152.3M/s)</sup> | **1.0&nbsp;allocs** | $O(N)$ epoch |
| **`artmap::ArtMap`**<br><sup>&nbsp;(Slice Lookup)</sup> | **19.6&nbsp;ns**<br><sup>(50.8M/s)</sup> | — | — | — | **0&nbsp;allocs** | $O(N)$ epoch |
| `arenaskiplist::SkipList`<br><sup>&nbsp;(with Inserter)</sup> | — | 39.4&nbsp;ns<br><sup>(25.4M/s)</sup> | — | — | **0&nbsp;allocs** | **$O(1)$** |
| `arenaskiplist::SkipList` | 171.9&nbsp;ns<br><sup>(5.8M/s)</sup> | 106.8&nbsp;ns<br><sup>(9.4M/s)</sup> | 156.4&nbsp;ns<br><sup>(6.4M/s)</sup> | 793&nbsp;ns<br><sup>(126.2M/s)</sup> | **0&nbsp;allocs** | **$O(1)$** |
| `crossbeam_skiplist::SkipMap` | 144.7&nbsp;ns<br><sup>(6.9M/s)</sup> | 75.3&nbsp;ns<br><sup>(13.3M/s)</sup> | 176.5&nbsp;ns<br><sup>(5.7M/s)</sup> | 2.19&nbsp;µs<br><sup>(45.7M/s)</sup> | ~1.0&nbsp;allocs | $O(N)$ epoch |
| `imbl::OrdMap` | 41.5&nbsp;ns<br><sup>(24.1M/s)</sup> | 52.8&nbsp;ns<br><sup>(19.0M/s)</sup> | 74.2&nbsp;ns<br><sup>(13.5M/s)</sup> | 341&nbsp;ns<br><sup>(293M/s)</sup> | ~0.14&nbsp;allocs | $O(N)$ heap |
| `std::collections::BTreeMap` | 58.6&nbsp;ns<br><sup>(17.1M/s)</sup> | 31.5&nbsp;ns<br><sup>(31.7M/s)</sup> | 64.7&nbsp;ns<br><sup>(15.5M/s)</sup> | **183&nbsp;ns**<br><sup>(546M/s)</sup> | ~0.17&nbsp;allocs | $O(N)$ heap |
| `std::collections::HashMap`* | 13.1&nbsp;ns<br><sup>(76.1M/s)</sup> | 18.7&nbsp;ns<br><sup>(53.5M/s)</sup> | 21.1&nbsp;ns<br><sup>(47.4M/s)</sup> | N/A | ~0&nbsp;allocs | $O(N)$ heap |
